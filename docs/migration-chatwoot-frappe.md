...
- [x] ~~`GOOGLE_OAUTH_CLIENT_ID` + `GOOGLE_OAUTH_CLIENT_SECRET` para Google SSO en Frappe CRM~~ ✅ Generadas y configuradas el 2026-05-04 (project `clinyco-crm`). Login Google operativo en `/app` y `/crm`. Detalle + troubleshooting en `migration/auth-google-sso.md`.
